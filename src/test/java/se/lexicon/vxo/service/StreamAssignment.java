...
public class StreamAssignment {
    ...
    public void task3(){
        ...
        //Write code here
        List<Person> lastNameAndersson = people.stream()
                .filter(person -> person.getLastName().equalsIgnoreCase("Andersson"))
                .collect(Collectors.toList());
        amount = lastNameAndersson.stream().count();
    ...
    public void task12(){
        ...
        result =  people.stream()
                .filter(person -> person.getFirstName().equalsIgnoreCase(String.valueOf(new StringBuilder(person.getFirstName()).reverse())))
